...
import PriceSection from "../main-components/price-section";
    ...
    <div className="min-h-screen bg-black text-white" ref={containerRef}>
      ...
      <main>
        ...
        <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-gray-500/30 to-black/50" />
          <video
            autoPlay
            loop
            muted
          ...
          >
            <source
              src="https://assets.mixkit.co/videos/preview/mixkit-digital-animation-of-a-city-11114-large.mp4"
              type="video/mp4"
            />
          </video>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="hero-description text-xl md:text-2xl mb-12 max-w-3xl mx-auto">
              BizNest - это место, где технологии встречаются с возможностями.
        ...
        <section className="w-full h-[4rem] bg-gradient-to-b from-black">

        </section>

        <HeroSection></HeroSection>
        {/* Features Section */}
        <section className="features-section py-20 bg-gradient-to-b from-gray-950 to-gray-900/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  title: "Развитие",
                  description:
                    "Комплексная поддержка для роста вашего стартапа",
                  image:
        ...
        {/* <section className="stats-section py-20 bg-gradient-to-b from-gray-900/30 to-black">
          <div className="container mx-auto px-4">
