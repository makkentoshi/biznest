...
export default function ChatPage() {
  ...
  const popularPrompts = [
    {
      title: "Подсчет данных",
      prompt: "Подсчитай все имеющиеся данные и составь рациональный бюджет товаров.",
    },
    {
      title: "Таргет-реклама",
      prompt: "Создай маркетинговую стратегию для интернет-магазина и правильную рекламу для привлечения новых клиентов.",
    },
    {
      title: "Масштабирование бизнеса",
      prompt: "Предложи  идей для масштабирования бизнеса в моей сфере.",
    },
  ];
  ...
  return (
    <div className="flex h-screen mt-[5rem]" ref={chatRef}>
      ...
      <div className="w-64 bg-gray-50 border-r p-4">
        <Button onClick={handleNewChat} className="w-full mb-4 bg-blue-900" >
      ...
      <div className="flex-1 flex flex-col">
        <Card className="flex-1 flex flex-col">
          ...
          <div className="sticky bottom-0 bg-white border-t p-4">
            <Card className="p-4 bg-gradient-to-br from-blue-800 to-gray-800 text-white">
